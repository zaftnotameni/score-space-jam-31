...
@export var lootlocker_player_public_uid : String = ''
...
static func copy(from:LootlockerPlayer, to:LootlockerPlayer) -> LootlockerPlayer:
	...
	to.lootlocker_player_public_uid = from.lootlocker_player_public_uid
...
static func initialize_from_web(data:LootlockerPlayer) -> LootlockerPlayer:
	...
	loaded.lootlocker_player_public_uid = LocalStorageBridge.local_storage_get_or_set_item('lootlocker_player_public_uid', loaded.lootlocker_player_public_uid)
...
static func save_to_web(data:LootlockerPlayer) -> LootlockerPlayer:
	...
	LocalStorageBridge.local_storage_set_item('lootlocker_player_public_uid', data.lootlocker_player_public_uid)
